...
class VariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variant" do
    assert_difference("Variant.count") do
      post variants_url, params: { variant: { availability: @variant.availability, car_id: @variant.car_id, details: @variant.details, model: @variant.model } }
    end
  ...
  test "should update variant" do
    patch variant_url(@variant), params: { variant: { availability: @variant.availability, car_id: @variant.car_id, details: @variant.details, model: @variant.model } }
